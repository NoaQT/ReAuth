...
final class CodeHandler extends Handler {
    ...
    public final void handle(HttpExchange exchange) throws IOException {
        try {
            ...
            LiteModReAuth.getLog().error("Exception while answering request", exception);
            throw exception;
        }
    }
    ...
    private Response handleRequest(String urlEncodedParameters) throws IOException {
        ...
        if (parameters.containsKey("code")) {
            LiteModReAuth.getLog().info("Received Microsoft Authentication Code");
            ...
            LiteModReAuth.getLog().error("Received Error from Microsoft Authentication: " + error);
